...
function init() {
    ...
    animationV.push(ani);
    ani=new animation(animationLib[4],25,ctx);
    animationV.push(ani);
...
//    timeTable.push(1);
    timeTable.push(1);
    timeTable.push(((1/animationV[1].fps)*animationV[1].sequence.length)-0.04);
    timeTable.push(((1/animationV[2].fps)*animationV[2].sequence.length)-0.04);
    timeTable.push(((1/animationV[3].fps)*animationV[3].sequence.length)-0.02);
    var sizeVec=[];
    var size=[];
    size[0]=300;
    size[1]=300;
...
//    size[1]=100;
    ...
    var move0=new move1([100,100],[100,100],1); 
    moveVec.push(move0);
    move0=new move1([100,100],[100,100],((1/animationV[1].fps)*animationV[1].sequence.length)-0.04);
    moveVec.push(move0);
    move0=new move1([100,100],[700,100],((1/animationV[2].fps)*animationV[2].sequence.length)-0.04);
    moveVec.push(move0);
    move0=new move1([700,100],[700,100],((1/animationV[3].fps)*animationV[3].sequence.length)-0.02);
    moveVec.push(move0);
    ...
    this.play=function(){
           ...
           this.pos=this.moveVec[this.index].nextPos(this.animationSeq[this.index].getTime());
            this.animationSeq[this.index].draw(this.pos[0],this.pos[1],this.size[0],this.size[1]);
                ...
                if(this.animationSeq[this.index].getTime()>=this.timeTable[this.index]){
