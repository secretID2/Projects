...
//    size[1]=100;
    ...
    moveVec.push(move0);
    move0=new move1([100,100],[100,100],((1/animationV[1].fps)*animationV[1].sequence.length));
    moveVec.push(move0);
    move0=new move1([100,100],[100,100],(1/animationV[1].fps)*animationV[2].sequence.length);
    moveVec.push(move0);
